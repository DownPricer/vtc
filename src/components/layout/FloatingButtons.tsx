...
export function FloatingButtons() {
  return (
    ...
    <div className="hidden md:flex fixed bottom-8 right-6 z-40 flex-col gap-3">
      ...
      <a
        href="/#radio"
        className="flex items-center justify-center w-14 h-14 rounded-full bg-dark border border-primary/40 text-primary shadow-glow hover:scale-110 transition-transform"
        aria-label="Radio YG VTC"
        title="Radio YG VTC"
      >
