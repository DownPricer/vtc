...
export function MobileCtaBar() {
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-50 pb-safe">
      {/* Fond flouté */}
      <div className="bg-dark/95 backdrop-blur-md border-t border-white/10 shadow-2xl px-4 pt-3 pb-3">
        <div className="flex gap-3">
          ...
          {/* Bouton WhatsApp — chat + appel */}
          <a
            href={`https://wa.me/33${PHONE.replace(/^0/, "")}?text=Bonjour%2C%20je%20souhaite%20r%C3%A9server%20un%20trajet.`}
            target="_blank"
          ...
          >
            ...
            <span className="text-[8px] font-bold leading-none">WA</span>
          </a>
