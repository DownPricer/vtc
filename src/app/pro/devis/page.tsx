  ...
  return (
    <ProGuard>
      <ProPanel>
        <ProSectionHeader
          title="Devis"
          description="Demandes de devis uniquement, avec des actions visibles pour ouvrir la fiche ou générer le document PDF."
          action={
                      ...
                      <td className="px-4 py-3 align-top">
                        <div className="flex flex-wrap gap-2">
                          <Link
                            ...
                            className="rounded-lg border border-[var(--pro-border)] bg-[var(--pro-panel-muted)] px-3 py-2 text-xs font-semibold text-[var(--pro-text)]"
                          >
                            Ouvrir
                          </Link>
            ...
            <div className="space-y-3 xl:hidden">
              {rows.map((row) => {
                ...
                return (
                  <div
                    key={row.id}
                    className="flex flex-col gap-4 rounded-xl border border-[var(--pro-border)] bg-[var(--pro-panel-muted)] px-4 py-4 sm:flex-row sm:items-center sm:justify-between"
                  >
                    ...
                    <div className="flex shrink-0 flex-wrap gap-2">
                      <Link
                        href={`/pro/demandes/${row.id}`}
                        className="rounded-xl border border-[var(--pro-border)] bg-[var(--pro-panel)] px-4 py-2.5 text-sm font-semibold text-[var(--pro-text)] hover:bg-[var(--pro-accent-soft)]"
                      >
                        Ouvrir
                      </Link>
